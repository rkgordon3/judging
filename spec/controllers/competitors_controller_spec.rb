  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved competitor as @competitor" do
        ...
        post :create, {:competitor => { "name" => "invalid value" }}, valid_session
        assigns(:competitor).should be_a_new(Competitor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested competitor" do
        ...
        Competitor.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => competitor.to_param, :competitor => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the competitor as @competitor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Competitor.any_instance.stub(:save).and_return(false)
        put :update, {:id => competitor.to_param, :competitor => { "name" => "invalid value" }}, valid_session
        assigns(:competitor).should eq(competitor)
      end
